...
const DefaultStyledInput = Box.withComponent("div");

const StyledInputBase = styled(({ form, ...props }) => (
...
const StyledInput = (props) => {
  ...
  return (
    <StyledInputBase readOnly tabIndex="-1" {...newFilteredProps}>
      {R.defaultTo(props.defaultValue, props.value)}
    </StyledInputBase>
  );
};
